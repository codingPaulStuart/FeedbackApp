        ...
        return Controller.extend("feedbackapp.feedbackapp.controller.Main", {
            ...
            onReviewListItemSelected: function (oEvent) {
                ...
                if (selectedKey === "Feedback") {
                    ...
                    //Use the selectedReview to set the Y180 header names
                    settingsModel.setProperty("/EmployeeName", selectedReview.EmployeeName);
                    settingsModel.setProperty("/ReviewerName", selectedReview.ReviewerName);
            ...
            onSelectEmployee: function (oEvent) {
                ...
                settingsModel.setProperty("/EmployeeName", selectedEmployee.Displayname);
                settingsModel.setProperty("/RoleName", selectedEmployee.Jobtitle);
                settingsModel.setProperty("/ManagerName", selectedEmployee.Manager);
                this.getPDPlanFromBackend("/PDplansList", "PDplans", null);
                var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
                oRouter.navTo("PDPlanDetails");
            },
