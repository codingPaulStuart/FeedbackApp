sap.ui.define([
    ...
    return Controller.extend("feedbackapp.feedbackapp.controller.PDPlanDetails", {
        ...
        //Admin wants to update the PD plan
        onUpdatePDplan: function (oEvent) {
