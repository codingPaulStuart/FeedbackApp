		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "T180 Feedback App",
									"targetURL": "#feedbackappfeedbackapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"feedbackappfeedbackapp-display": {
								"semanticObject": "feedbackappfeedbackapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=feedbackapp.feedbackapp",
									"url": sap.ui.require.toUrl("feedbackapp/feedbackapp")
								}
							}
						}
					}
