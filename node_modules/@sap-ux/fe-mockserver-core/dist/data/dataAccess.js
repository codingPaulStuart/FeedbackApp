            ...
            if (actionDefinition) {
                if (actionDefinition.sourceType !== '') {
                    ...
                    if (targetEntitySet) {
                        ...
                        return (_b = (await mockEntityContainer_1.MockEntityContainer.read(this.mockDataRootFolder, this.fileLoader))) === null || _b === void 0 ? void 0 : _b.executeAction(actionDefinition, Object.assign({}, actionData), odataRequest.queryPath[0].keys || {}, odataRequest);
                    }
                }
                    ...
                    // There is no entitySet linked to it, handle it in the EntityContainer.js potentially as executeAction
                    return (_c = (await mockEntityContainer_1.MockEntityContainer.read(this.mockDataRootFolder, this.fileLoader))) === null || _c === void 0 ? void 0 : _c.executeAction(actionDefinition, Object.assign({}, actionData), odataRequest.queryPath[0].keys || {}, odataRequest);
                }
            }
        }
        return null;
